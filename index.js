...
(function($PS) {
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Button (line 17, column 16 - line 22, column 34): " + [ v.constructor.name ]);
  };
  var button = function (buttonType) {
      return function (classes) {
          return function (content) {
              var buttonTypeClassName = (function () {
                  if (buttonType instanceof Primary) {
                      return "flx-button-" + "primary";
                  };
                  if (buttonType instanceof Secondary) {
                      return "flx-button-" + "secondary";
                  };
                  if (buttonType instanceof Success) {
                      return "flx-button-" + "success";
                  };
                  if (buttonType instanceof Info) {
                      return "flx-button-" + "info";
                  };
                  if (buttonType instanceof Warning) {
                      return "flx-button-" + "warning";
                  };
                  if (buttonType instanceof Help) {
                      return "flx-button-" + "help";
                  };
                  if (buttonType instanceof Danger) {
                      return "flx-button-" + "danger";
                  };
                  throw new Error("Failed pattern match at Button (line 69, column 27 - line 76, column 35): " + [ buttonType.constructor.name ]);
              })();
              return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flx-button", buttonTypeClassName ])(classes)) ])([ content ]);
          };
      };
  };
  var render = function (v) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "flex-row", "mt-4", "ml-4" ]) ])([ button(Primary.value)([ "mr-2" ])(Halogen_HTML_Core.text("Primary")), button(Secondary.value)([ "mr-2" ])(Halogen_HTML_Core.text("Secondary")), button(Success.value)([ "mr-2" ])(Halogen_HTML_Core.text("Success")), button(Info.value)([ "mr-2" ])(Halogen_HTML_Core.text("Info")), button(Warning.value)([ "mr-2" ])(Halogen_HTML_Core.text("Warning")), button(Help.value)([ "mr-2" ])(Halogen_HTML_Core.text("Help")), button(Danger.value)([  ])(Halogen_HTML_Core.text("Danger")) ]);
  };
  var buttonComponent = Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Button.buttonComponent)(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();